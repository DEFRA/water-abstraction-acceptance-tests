...
export default function () {
  ...
  for (let i = 0; i < dataModel.returnLogs.length; i++) {
    ...
    dataModel.returnLogs[i].metadata.description = dataModel.returnRequirements[0].siteDescription
    dataModel.returnLogs[i].metadata.isSummer = dataModel.returnRequirements[0].summer
    ...
    dataModel.returnLogs[i].returnReference = dataModel.returnRequirements[0].legacyId
    dataModel.returnLogs[i].returnRequirementId = dataModel.returnRequirements[0].id
