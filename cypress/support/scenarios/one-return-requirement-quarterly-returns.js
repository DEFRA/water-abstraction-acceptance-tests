...
export default function basicLicenceOneReturnRequirementQuarterlyReturns () {
  ...
  dataModel.returnLogs[0].id = `v1:9:AT/TEST/01:9999990:${startYear + 1}-01-01:${endYear}-03-31`
  ...
  dataModel.returnLogs[1].id = `v1:9:AT/TEST/01:9999990:${startYear}-10-01:${startYear}-12-31`
  ...
  dataModel.returnLogs[2].id = `v1:9:AT/TEST/01:9999990:${startYear}-07-01:${startYear}-09-30`
  ...
  dataModel.returnLogs[3].id = `v1:9:AT/TEST/01:9999990:${startYear}-04-01:${startYear}-06-30`
