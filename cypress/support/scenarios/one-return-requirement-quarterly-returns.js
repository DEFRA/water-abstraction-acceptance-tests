...
export default function () {
  ...
  dataModel.returnLogs[0].returnId = `v1:9:AT/TE/ST/01/01:9999990:${startYear + 1}-01-01:${endYear}-03-31`
  ...
  dataModel.returnLogs[1].metadata.description = dataModel.returnRequirements[0].siteDescription
  dataModel.returnLogs[1].metadata.isSummer = dataModel.returnRequirements[0].summer
  dataModel.returnLogs[1].returnCycleId.value = `${startYear}-04-01`
  dataModel.returnLogs[1].returnId = `v1:9:AT/TE/ST/01/01:9999990:${startYear}-10-01:${startYear}-12-31`
  dataModel.returnLogs[1].returnReference = dataModel.returnRequirements[0].legacyId
  dataModel.returnLogs[1].returnRequirementId = dataModel.returnRequirements[0].id
  ...
  dataModel.returnLogs[2].returnId = `v1:9:AT/TE/ST/01/01:9999990:${startYear}-07-01:${startYear}-09-30`
  ...
  dataModel.returnLogs[3].metadata.description = dataModel.returnRequirements[0].siteDescription
  dataModel.returnLogs[3].metadata.isSummer = dataModel.returnRequirements[0].summer
  dataModel.returnLogs[3].returnCycleId.value = `${startYear}-04-01`
  dataModel.returnLogs[3].returnId = `v1:9:AT/TE/ST/01/01:9999990:${startYear}-04-01:${startYear}-06-30`
  dataModel.returnLogs[3].returnReference = dataModel.returnRequirements[0].legacyId
  dataModel.returnLogs[3].returnRequirementId = dataModel.returnRequirements[0].id
