...
test.describe('SROC charge information journey (internal)', () => {
  ...
  test('journey', async ({ page }) => {
    ...
    await page.getByRole('radio', { name: /Spray Irrigation - Direct/i }).check()
    // await page.getByRole('button', { name: 'Continue' }).click()
    ...
    // await expect(page.locator('h1')).toContainText('Licence set up')
    // await page.getByRole('cell', { name: 'April 2025' }).nth(1).click()
    // await page.getByRole('cell').filter({ hasText: /^$/ }).nth(2).click()
    // await page.getByRole('cell', { name: 'New licence' }).click()
    // await page.getByText('replaced').click()
    // await page.getByRole('cell', { name: 'April 2025' }).first().click()
    // await page.getByRole('cell').filter({ hasText: /^$/ }).nth(1).click()
    // await page.getByRole('cell', { name: 'Error correction' }).click()
    // await page.getByText('approved').click()
    // await page.getByRole('cell', { name: 'July 2026' }).click()
    // await page.getByRole('cell').nth(1).click()
    // await page.getByRole('cell', { name: 'Major change' }).click()
    // await page.getByRole('cell', { name: 'Major change' }).click()
    ...
    // await expect(page.locator('h1')).toContainText('Licence set up')
    // await page.getByRole('cell', { name: '27 July' }).click()
    // await page.getByRole('cell').nth(1).click()
    // await page.getByRole('cell', { name: 'Major change' }).click()
    // await page.getByRole('row', { name: '27 July 2026 Major change' }).getByRole('strong').click()
    // await page.getByRole('cell', { name: 'April 2025' }).first().click()
    // await page.getByRole('cell', { name: '26 July' }).click()
    // await page.getByRole('cell', { name: 'Error correction' }).click()
    // await page.getByRole('row', { name: '1 April 2025 26 July 2026' }).getByRole('strong').click()
  })
})
