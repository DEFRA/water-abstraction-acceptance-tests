...
import { dueDateStatusLabel, formatLongDate } from '../../support/helpers/date.helpers.js'

let licence
let returnLogs
let startYear

test.describe('Submit winter and all year historic correction using abstraction data (internal)', () => {
