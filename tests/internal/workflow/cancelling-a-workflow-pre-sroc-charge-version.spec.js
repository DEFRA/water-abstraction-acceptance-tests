import scenarioData from '../../support/scenarios/licence-with-pre-sroc-charge-version-workflow-and-bill-run.scenario.js'
import { formatLongDate } from '../../support/helpers/date.helpers.js'
import { test, expect } from '../../support/fixtures.js'

test.describe('Cancelling a workflow item (internal)', { tag: ['@presroc', '@supplementaryBilling'] }, () => {
  let company
  let licence
