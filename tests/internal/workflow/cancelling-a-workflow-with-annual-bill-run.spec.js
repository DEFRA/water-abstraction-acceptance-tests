...
test.describe(
  'Cancelling a workflow item (internal)',
  {
    ...
    annotation: {
      type: 'info',
      description:
        'When the the licence is in workflow, and you cancel a workflow item, and there is an annual bill run, and the workflow was created during the billing period, the licence should be flagged for supplementary billing'
    }
  },
  () => {
    let company
