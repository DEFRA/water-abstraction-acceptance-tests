 ...
 * @module DetermineBillingPeriodsHelper
 */
 ...
 *
 * Ported from `DetermineBillingPeriodsService` in water-abstraction-system, which the acceptance tests previously
 * called via the `/system/data/dates` endpoint.
 *
 ...
 */
export function determineBillingPeriods(billRunType, financialYearEnding) {
