...
export default function (calculatedDates) {
  ...
  const previousPeriodDetails = previousPeriod({
    ...
    dueDate: currentWinterReturnCycle.endDate,
    quarterly: false
  })
  ...
  const receivedDate = new Date(previousReturnLog.returnLogs[0].dueDate)
  receivedDate.setUTCDate(receivedDate.getUTCDate() + 3)
  previousReturnLog.returnLogs[0].receivedDate = formatDateToIso(receivedDate)
