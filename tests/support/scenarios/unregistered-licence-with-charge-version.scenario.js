...
export const description = 'An unregistered licence, licence holder, company, charge version and billing account'
...
export default function () {
  ...
  return mergeByKey(unregisteredLicence, billingAccount, chargeVersion)
}
